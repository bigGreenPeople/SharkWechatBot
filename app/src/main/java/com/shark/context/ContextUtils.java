...
public class ContextUtils {
    ...
    private ContextUtils(ClassLoader classLoader, Application application) {
        this.mClassLoader = classLoader;
        this.mApplication = application;

    }

    public static synchronized ContextUtils getInstance(ClassLoader classLoader, Application application) {
        if (mContextUtils == null) {
            mContextUtils = new ContextUtils(classLoader, application);
        }
    ...
    public Application geApplication() {
        try {
            ...
            if (application == null) return mApplication;
            return application;
        } catch (Exception e) {
